...
import es.ull.etsii.testastrolabos.Helpers.ActivityResultHandler;
import es.ull.etsii.testastrolabos.Helpers.FileManager;
import es.ull.etsii.testastrolabos.Helpers.PermissionManager;
import es.ull.etsii.testastrolabos.Helpers.PermissionResultHandler;
import es.ull.etsii.testastrolabos.OtherActivities.InfoActivity;
import es.ull.etsii.testastrolabos.OtherActivities.SettingsActivity;
import es.ull.etsii.testastrolabos.OtherActivities.ShareActivity;
